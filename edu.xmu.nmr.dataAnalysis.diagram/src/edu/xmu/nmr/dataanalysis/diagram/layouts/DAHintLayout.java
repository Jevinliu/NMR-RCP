...
public class DAHintLayout extends AbstractHintLayout {
    ...
    private IFigure center, left, top, bottom, right, topLeft, topRight,
    ...
    @Override public void layout(IFigure container) {
        ...
        if (bottom != null && bottom.isVisible()) {
            childSize = bottom.getPreferredSize(areaSize.width,
                    areaSize.height);
            rect.setSize(childSize);
            rect.x = (area.width - childSize.width) / 2 + origin.x;
        ...
        if (center != null && center.isVisible()) {
            childSize = center.getPreferredSize(areaSize.width,
                    areaSize.height);
            rect.setSize(childSize);
            rect.x = (area.width - childSize.width) / 2 + origin.x;
            rect.y = (area.height - childSize.height) / 2 + origin.y;
        ...
        if (topLeft != null && topLeft.isVisible()) {
            childSize = topLeft.getPreferredSize(areaSize.width,
                    areaSize.height);
            rect.setSize(childSize);
            rect.x = hMargin + origin.x;
            rect.y = vMargin + origin.y;
        ...
        if (topRight != null && topRight.isVisible()) {
            childSize = topRight.getPreferredSize(areaSize.width,
                    areaSize.height);
            rect.setSize(childSize);
            rect.x = area.width - childSize.width - hMargin + origin.x;
            rect.y = vMargin + origin.y;
        ...
        if (bottomLeft != null && bottomLeft.isVisible()) {
            childSize = bottomLeft.getPreferredSize(areaSize.width,
                    areaSize.height);
            rect.setSize(childSize);
            rect.x = hMargin + origin.x;
            rect.y = area.height - childSize.height - vMargin + origin.y;
        ...
        if (bottomRight != null && bottomRight.isVisible()) {
            childSize = bottomRight.getPreferredSize(areaSize.width,
                    areaSize.height);
            rect.setSize(childSize);
            rect.x = area.width - childSize.width - hMargin + origin.x;
            rect.y = area.height - childSize.height - vMargin + origin.y;
        ...
        if (bottomCenter != null && bottomCenter.isVisible()) {
            childSize = bottomCenter.getPreferredSize(areaSize.width,
                    areaSize.height);
            rect.setSize(childSize);
            rect.x = (area.width - childSize.width - 2 * hMargin) / 2
                    + origin.x;
            rect.y = area.height - childSize.height - vMargin + origin.y;
     ...
     */
    @Override public void setConstraint(IFigure child, Object constraint) {
        remove(child);
