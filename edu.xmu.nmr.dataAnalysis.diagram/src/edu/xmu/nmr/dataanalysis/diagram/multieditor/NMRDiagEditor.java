...
public class NMRDiagEditor extends MultiPageEditorPart {
    ...
    private SpecEditorPage specEditorPage;
    ...
    public void setAcitvePage(AbstractDataNode node) {
        if (node instanceof FidNode) {
            this.setActiveEditor(fidEditorPage);
            ;
        } else if (node instanceof ParamtersNode) {
            this.setActiveEditor(paramsEditorPage);
        } else {
            this.setActiveEditor(specEditorPage);
        }
    }
    
    @Override public IEditorPart getActiveEditor() {
